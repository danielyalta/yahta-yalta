...
const NotFoundPage = () => {
  return (
    <div className="from-darkblue to-darkblue2 relative flex min-h-screen flex-col items-center justify-center overflow-hidden bg-gradient-to-br font-sans text-white">
      <div className="relative z-10 flex flex-col items-center p-8 pt-[100px] text-center">
        ...
        <h1 className="mb-4 text-3xl leading-tight font-bold drop-shadow-2xl sm:text-5xl">
          Затерялись в открытом море...
        </h1>

        <p className="text-opacity-90 mb-8 max-w-lg text-white sm:text-lg">
